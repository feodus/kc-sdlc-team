---
description: A powerful universal coding agent with extended capabilities covering all major frameworks, best practices, and development workflows. Integrated with Project Manager for coordination.
mode: primary
color: "#FF5733"
skills:
  - fastapi-development
...
- **create-custom-agent**: Creating custom agents for KiloCode
...
- `project_artifacts/arch_artifacts/architecture/`
...
- `project_artifacts/arch_artifacts/architecture/` — Architecture documents
- `project_artifacts/arch_artifacts/decisions/` — ADRs
