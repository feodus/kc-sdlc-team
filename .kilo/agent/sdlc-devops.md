---
description: DevOps Engineer for CI/CD pipelines, Docker, Kubernetes, infrastructure automation, and deployment coordination. Coordinates with Universal Coding Agent for application deployment and with Project Manager for infrastructure planning.
mode: primary
color: "#F39C12"
skills:
  - ci-cd-pipelines
