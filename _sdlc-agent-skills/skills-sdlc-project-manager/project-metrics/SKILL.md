...
description: Project metrics and EVM management. Use for calculating CPI, SPI, EVM, analyzing velocity, cycle time, lead time trends, and preparing stakeholder reports. Strategic level — focus on forecasts and analytics.
---

# Project Metrics

> **Meta:** v2.0.0 | 09-03-2026
> **Updated:** Added clarification on scope and connection to development-tracking
...
- When preparing reports for stakeholders
- When analyzing plan deviations
- When forecasting completion dates
- When evaluating team effectiveness
- When calculating EVM metrics (CPI, SPI, EAC)

**Note:** For operational development progress tracking (daily standups, current burndown) use the [`development-tracking`](development-tracking/SKILL.md) skill.
...
- [`development-tracking`](development-tracking/SKILL.md) — operational progress tracking (burndown, daily standups)
- [`stakeholder-reporting`](stakeholder-reporting/SKILL.md) — stakeholder reporting
- [`release-deployment-management`](release-deployment-management/SKILL.md) — release metrics
- [`agile-scrum-management`](agile-scrum-management/SKILL.md) — Agile practices

---

*Part of Project Manager SDLC Skills — Phase 7: Support and Maintenance*
*Updated: v2.0, 09-03-2026*