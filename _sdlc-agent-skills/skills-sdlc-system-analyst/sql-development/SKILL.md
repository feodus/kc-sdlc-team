...
This skill is a logical continuation of the `data-modeling` skill and provides ready-to-use SQL queries for implementation in sdlc-coder.
...
- SA validates queries with PM before passing to sdlc-coder
