...
Skill for designing integration patterns between systems and services. Includes choosing between synchronous and asynchronous integration, designing message-based architecture (Message Brokers), designing Event-Driven architecture, designing ESB patterns, and handling errors in distributed systems. The skill provides complete integration architecture for implementation in sdlc-coder.
