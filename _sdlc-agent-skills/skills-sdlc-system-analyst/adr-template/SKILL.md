...
- **[c4-architecture](/_sdlc-agent-skills/skills-sdlc-system-analyst/c4-architecture/SKILL.md)**: C4 diagrams complement ADR with visualization
- **[srs-specification](/_sdlc-agent-skills/skills-sdlc-system-analyst/srs-specification/SKILL.md)**: SRS contains requirements that ADR relies on
- **[api-design](/_sdlc-agent-skills/skills-sdlc-system-analyst/api-design/SKILL.md)**: API design extends architectural decisions to the interface level
