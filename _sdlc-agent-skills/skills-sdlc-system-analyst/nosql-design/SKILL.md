...
This skill is an alternative to relational design (`data-modeling`) and provides NoSQL schemas for implementation in sdlc-coder when working with non-relational stores.
...
- SA validates solution with PM before passing to sdlc-coder
